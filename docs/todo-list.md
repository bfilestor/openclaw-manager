...
## Epic 13：Skills 安装删除增强

> **Sprint 9** | 目标：支持按 global/agent 粒度安装与删除 Skills，并限定上传格式。

### Story E13-S1：Skills 页面增强

| Issue | 描述 | 优先级 | SP | 状态 | 依赖 | 测试类型 | 测试结果 | 备注 |
|-------|------|--------|----|------|------|----------|----------|------|
| E13-S1-I60 | Skills 页面支持安装（scope + agent）与删除操作 | P1 | 4 | Done | E6-S1-I34, E6-S1-I35, E9-S3-I52 | Integration | Passed | 已支持列表过滤与安装表单 |

### Story E13-S2：Install API 增强

| Issue | 描述 | 优先级 | SP | 状态 | 依赖 | 测试类型 | 测试结果 | 备注 |
|-------|------|--------|----|------|------|----------|----------|------|
| E13-S2-I61 | Install API 支持 agent scope，上传格式限定 zip/tar.gz | P1 | 3 | Done | E6-S2-I36, E5-S1-I29 | Unit + Integration | Passed | 已支持 agent_id 参数与格式校验 |

*清单总计 61 条 Issue，分布于 9 个 Sprint（约15周）。每完成一条请更新对应状态与测试结果。*
